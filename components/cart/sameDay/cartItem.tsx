...
const SameDayCartItem = ({ ...props }: CartItemProperties) => {
    ...
    return (
        <div className="cart-item pb-4 pt-2">
            <div className="flex">
                <button
...
const SameDayCartItemMemo = React.memo(SameDayCartItem)

export default SameDayCartItemMemo